...
export async function POST(req: Request) {
    try {
        ...
        <head>
            <meta charset="UTF-8" />
            <title>Bienvenido a Moreci Shop</title>
            <style>
            body {
        ...
        <body>
            ...
            <p>
                Tu cuenta ha sido creada con éxito. En Moreci Shop creemos que cada compra
                debe ser una experiencia épica. 🌿💥
            </p>
            ...
            <footer>
                © 2025 Moreci Shop · Todos los derechos reservados · Medellín 💚
            </footer>
            </div>
        </body>
        </html>
